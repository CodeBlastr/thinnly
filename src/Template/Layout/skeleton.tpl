...
<body>
		...
		<footer>
			<div class="row">
				<div class="col-lg-12">
					...
					<p>Made by <a href="http://thomaspark.co" rel="nofollow">Thomas Park</a>. Contact him at <a href="/cdn-cgi/l/email-protection#1c687473717d6f5c7e7373686f6b7d687f74327f7371"><span class="__cf_email__" data-cfemail="b8ccd0d7d5d9cbf8dad7d7cccbcfd9ccdbd096dbd7d5">[email&#160;protected]</span><script data-cfhash='f9e31' type="text/javascript">/* <![CDATA[ */!function(t,e,r,n,c,a,p){try{t=document.currentScript||function(){for(t=document.getElementsByTagName('script'),e=t.length;e--;)if(t[e].getAttribute('data-cfhash'))return t[e]}();if(t&&(c=t.previousSibling)){p=t.parentNode;if(a=c.getAttribute('data-cfemail')){for(e='',r='0x'+a.substr(0,2)|0,n=2;a.length-n;n+=2)e+='%'+('0'+('0x'+a.substr(n,2)^r).toString(16)).slice(-2);p.replaceChild(document.createTextNode(decodeURIComponent(e)),c)}p.removeChild(t)}}catch(u){}}()/* ]]> */</script></a>.</p>
	...
	{% set fields = {'name': {'value': 'two'}} %}

	{{ fields|debug }}

    {{ _view.element('blocks/breadcrumbs', {'dataName': fields})|raw }}

    {% element 'blocks/breadcrumbs' {dataName: 'dataValue'} {optionName: 'optionValue'} %}
